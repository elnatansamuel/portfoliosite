...
export function Skills() {
  return (
    <section
      id="skills"
      className="py-10 px-6 bg-black relative border-t border-white/5"
    >
      <div className="max-w-7xl mx-auto px-10 border-x border-white/5 lg:py-20 relative">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-px bg-white/10 border border-white/10">
          {stack.map((item, index) => (
            ...
            >
              <div className="mb-6 text-neutral-600 group-hover:text-white transition-all transform group-hover:scale-110">
                {item.icon}
              </div>
